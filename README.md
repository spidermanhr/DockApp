...
**DockApp** je besplatan program za **Windows 11** koji vraća funkcionalnost popularne *Quick Launch* trake iz ranijih verzija sustava, s posebnim naglaskom na stil rada karakterističan za Windows 7.

---

## 🚀 Ključne značajke

* **Fleksibilno postavljanje:** DockApp se ponaša kao dodatni Taskbar koji možete smjestiti bilo gdje na zaslonu:
    * `Top` (Gore)
    * `Bottom` (Dolje)
    * `Left` (Lijevo)
    * `Right` (Desno)
...
![DockApp Screenshot 2](https://raw.githubusercontent.com/spidermanhr/DockApp/master/guick_launch_2.jpg)https://github.com/spidermanhr/DockApp/blob/master/guick_launch.jpg
